...
public class Kuiz extends Activity{
   ...
   // private int detik = 150 * 1000; // --> 10 menit
   ...
   // private void setUpWaktu() {
          ...
          //  public void onTick(long millisUntilFinished)
            ...
            //{
             ...
             //   txtwaktu.setText("Sisa waktu: 0 menit");
               // Toast.makeText(Kuiz.this, "Waktu Habis",
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Kuiz.this).create();
            tampilKotakAlert.setTitle("Skor");
                      ...
                      //  public void onClick(DialogInterface dialog, int which) {
                        //    cekPertanyaan = false;
                          //  urutanPertanyaan = 0;
                            ...
                            //Kuiz.this.tunjukanPertanyaan(0,
                      //              cekPertanyaan);
                        //}
                    //});
